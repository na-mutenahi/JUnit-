...
public class C01_Xpath {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement deleteButonElemeni = driver.findElement(By.xpath("//button[@onclick= 'deleteElement()']"));

        if (deleteButonElemeni.isDisplayed()){
