...
public class C03_CssSelector {
    public static void main(String[] args) {
        ...
        if (actualTitle.contains(expectedIcerik)){
            ...
            System.out.println("Title testi FIALED");
        }
        ...
        driver.findElement(By.xpath("(//span[@class='a-truncate-cut'])[1]")).click(); driver.findElement(By.cssSelector("a[data-csa-c-content-id='nav_cs_gc']")).click();
