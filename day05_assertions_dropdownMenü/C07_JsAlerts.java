...
public class C07_JsAlerts extends TestBaseClass {
    ...
    public void Test02(){
        ...
        String actualSonucYazısı= driver
                .findElement(By.xpath("//*[@id='result']"))
                .getText();

        Assert.assertEquals(expectedSonucYazisi,actualSonucYazısı);
    ...
    public void test03(){
        ...
        String actuelSonucYazisi= driver
                .findElement(By.xpath("//*[@id='result']"))
                .getText();
        String expektedIcerik="Abdullah";

        Assert.assertTrue(actuelSonucYazisi.contains(expektedIcerik));
    }
