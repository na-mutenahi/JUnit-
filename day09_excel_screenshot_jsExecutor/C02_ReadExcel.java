...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        //   -1. satirdaki 2. hucreyi bir string değiskene  atayalim ve yazdiralim
        ...
        //   -2.satir 4.cell'in afkanistan'in baskenti olduğunu test edelim
        ...
        //   -Sayfa2'deki satir sayisi ve Fiziki olarak kullanılan satir sayisini bulun
        ...
        for (int i = 1; i <=sonSatirIndexi ; i++) { // basligi almamak için 1'den baslattim
