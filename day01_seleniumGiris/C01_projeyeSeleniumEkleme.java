...
public class C01_projeyeSeleniumEkleme {
    /*
    Bir projede selenium ile otomasyon yapabilemek için
    projeye 2 sey eklemeliyiz
    1- Selenium kutuphanesi
    2- Kullanmak istediğimiz browser(lar) in selenium driver'i
    (Biz sadece chrome kullanip sonra daha geilişmiş framerwork'lere geciş yapacagiz)
