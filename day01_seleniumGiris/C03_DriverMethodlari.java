...
public class C03_DriverMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // gittiiginiz sayfadaki title ve url'i yazdirin
        ...
        // ornegin url amazon içeriyorsa diyebiliriz

        String expectedIcerik = "amazon";
        String actualUrl = driver.getCurrentUrl();

        if (actualUrl.contains(expectedIcerik)) { // amazon anayasfaya gittiysek
